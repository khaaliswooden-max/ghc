...
Because this project touches juristic and authority-specific subject
matter, we additionally pledge:

* Treating differences between Shariah authorities, schools of
  thought, and certifying bodies as a first-class technical concern
  rather than a debate to be won.
* Refraining from declaring any specific Shariah authority,
  jurisprudential school, or fatwa "correct" or "incorrect" in
  project communication; the protocol's role is to encode positions
  faithfully, not to adjudicate them.
* Documenting differences between authorities transparently.
...
* Sectarian agitation, denominational gatekeeping, or attempts to
  use the project as a venue for adjudicating juristic disputes.
...
using an official e-mail address, posting via an official social media
...
may be reported to the maintainers responsible for enforcement at the
address in [SECURITY.md](SECURITY.md) under "non-security conduct
reports". All complaints will be reviewed and investigated promptly
and fairly.
...
with project-specific additions reflecting GHC's authority-parametric
subject matter.
